...
def build_prompt(ctx, profile: Profile, rag_examples: str,
    ...
    system = (
        ...
        "- funny clip -> laughing is right (😂, 💀, lmao)\n"
        "- flex / impressive / sports -> hype is right (🔥, goes crazy, W)\n"
        "- wholesome / heartfelt (a reunion, a baby, a kind moment) -> a WARM "
        "reaction (🥹, ❤️, 🥺). NEVER laugh (no 😂/💀/lmao) and never hype it.\n"
        "- sad / serious / grief -> an EMPATHETIC reaction (😭, 🥹, ❤️, 🙏). "
        "Never laugh or hype.\n"
        "- educational / informative (a fact, history, an explainer) -> a curious "
        "or impressed reaction (🤯, 👏, 🧠, \"no way\", \"TIL\", 🔥 as \"cool\"). "
        "Do NOT laugh (no 😂/💀/lmao) — you're not laughing AT a lesson.\n"
        "Laughing or hyping heartfelt, sad, or educational content is a serious "
        "mistake even if a comment does it — react to the CONTENT's tone.\n\n"
